import { createFileRoute, lazyRouteComponent, createRootRoute, Outlet, RouterProvider, useLocation, Link, createRouter as createRouter$1 } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-BQN2i3m2.mjs');
...
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxs("footer", { className: "relative mt-20 bg-gray-900/50 backdrop-blur-sm border-t border-gray-800", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-500 to-transparent" }),
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-16", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsx("h3", { className: "font-display text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400", children: "MovieFinder" }),
            /* @__PURE__ */ jsx("p", { className: "font-body text-gray-300 text-lg leading-relaxed max-w-md", children: "Discover amazing movies without the hassle. Powered by The Movie Database (TMDB) to bring you the latest and greatest in cinema." })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex space-x-4", children: [
            ...
            "a",
            {
              ...
              children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: social.icon }) })
            },
            social.name
          )) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-display text-lg font-semibold text-white", children: "Quick Links" }),
          /* @__PURE__ */ jsx("ul", { className: "font-body space-y-3", children: ["Popular Movies", "Top Rated", "Upcoming", "Now Playing", "Trending"].map((link) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
            "a",
            {
              href: "#",
              className: "text-gray-400 hover:text-purple-400 transition-colors duration-200 flex items-center space-x-2 group",
              children: [
                /* @__PURE__ */ jsx("span", { className: "w-1 h-1 bg-purple-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-display text-lg font-semibold text-white", children: "Support" }),
          /* @__PURE__ */ jsx("ul", { className: "font-body space-y-3", children: ["Help Center", "API Documentation", "Contact Us", "Privacy Policy", "Terms of Service"].map((link) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
            "a",
            {
              href: "#",
              className: "text-gray-400 hover:text-purple-400 transition-colors duration-200 flex items-center space-x-2 group",
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-2xl p-8 mb-12 border border-purple-500/20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto text-center space-y-4", children: [
        /* @__PURE__ */ jsx("h4", { className: "font-display text-2xl font-bold text-white", children: "Stay Updated" }),
        /* @__PURE__ */ jsx("p", { className: "font-body text-gray-300", children: "Get the latest movie recommendations and updates delivered to your inbox." }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3 max-w-md mx-auto", children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105", children: "Subscribe" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-800", children: [
        /* @__PURE__ */ jsxs("div", { className: "font-body text-gray-400 text-sm mb-4 md:mb-0", children: [
          "© ",
          currentYear,
          " MovieFinder. Made with ❤️ for movie lovers."
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center space-x-6 text-sm", children: [
          /* @__PURE__ */ jsxs("a", { href: "https://www.themoviedb.org/", target: "_blank", rel: "noopener noreferrer", className: "flex items-center space-x-2 text-gray-400 hover:text-white transition-colors duration-200", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "font-body text-gray-400", children: "Built with React & TypeScript" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute -bottom-20 -right-20 w-40 h-40 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -bottom-20 -left-20 w-40 h-40 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10" })
    ] })
  ] });
};
const NavBar = () => {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: "relative bg-gray-900/50 backdrop-blur-sm border-b border-gray-800 z-40", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-500 to-transparent" }),
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between h-16", children: [
        /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex items-center space-x-3 group", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300", children: /* @__PURE__ */ jsx("svg", { className: "w-6 h-6 text-white", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx("path", { d: "M2 6a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z" }) }) }),
            /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-300" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsx("h1", { className: "font-display text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 group-hover:from-purple-300 group-hover:to-pink-300 transition-all duration-300", children: "MovieFinder" }) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "hidden md:flex items-center space-x-8", children: navigationItems.map((item) => /* @__PURE__ */ jsxs(
          Link,
          {
            to: item.path,
            className: `relative flex items-center space-x-2 px-4 py-2 rounded-xl font-medium transition-all duration-300 group ${isActivePath(item.path) ? "text-white bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30" : "text-gray-300 hover:text-white hover:bg-gray-800/50"}`,
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-body", children: item.name }),
              isActivePath(item.path) && /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-2 w-1 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" }),
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-purple-600/10 to-pink-600/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" })
            ]
          },
          item.path
        )) }),
        /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center space-x-4", children: [
          /* @__PURE__ */ jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 group-hover:scale-110 transition-transform duration-200", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" }) })
            }
          ),
          /* @__PURE__ */ jsx("button", { className: "p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200 group", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 group-hover:scale-110 transition-transform duration-200", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" }) }) })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      isMobileMenuOpen && /* @__PURE__ */ jsx("div", { className: "md:hidden py-4 border-t border-gray-800 animate-in slide-in-from-top-2 duration-200", children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        navigationItems.map((item) => /* @__PURE__ */ jsxs(
          Link,
          {
            to: item.path,
            onClick: () => setIsMobileMenuOpen(false),
            className: `flex items-center space-x-3 px-4 py-3 rounded-xl font-medium transition-all duration-300 ${isActivePath(item.path) ? "text-white bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30" : "text-gray-300 hover:text-white hover:bg-gray-800/50"}`,
            children: [
              /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: item.icon }) }),
              /* @__PURE__ */ jsx("span", { className: "font-body", children: item.name })
            ]
        ...
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center space-x-4 pt-4 border-t border-gray-800", children: /* @__PURE__ */ jsxs(
          "a",
          {
            href: "https://github.com/YounesBouhouche/movie-finder",
            target: "_blank",
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-body", children: "GitHub" })
            ]
          }
        ) })
      ] }) })
...
const App = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900", children: [
    /* @__PURE__ */ jsx(NavBar, {}),
...
function RootComponent() {
  return /* @__PURE__ */ jsx(React.Fragment, { children: /* @__PURE__ */ jsx(App, { children: /* @__PURE__ */ jsx(Outlet, {}) }) });
}
const $$splitComponentImporter$5 = () => import('./shows-BXmFUEpg.mjs');
const Route$5 = createFileRoute("/shows")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import('./about-C34S-xrS.mjs');
const Route$4 = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./_splat-BgOOuYYU.mjs');
const Route$3 = createFileRoute("/$splat")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./index-C4jp_5LG.mjs');
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import('./tv._tvId-Dx2hiEjL.mjs');
const Route$1 = createFileRoute("/tv/$tvId")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./movie._movieId-bG8TcPD1.mjs');
const Route = createFileRoute("/movie/$movieId")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ShowsRoute = Route$5.update({
  id: "/shows",
  path: "/shows",
...
const TvTvIdRoute = Route$1.update({
  id: "/tv/$tvId",
  path: "/tv/$tvId",
  getParentRoute: () => Route$6
});
const MovieMovieIdRoute = Route.update({
  id: "/movie/$movieId",
  path: "/movie/$movieId",
  getParentRoute: () => Route$6
});
...
export { Route$1 as R, Route as a, serverEntry as default };
