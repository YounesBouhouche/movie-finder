...
const TvDialog = ({ tv, onClose }: TvDialogProps) => {
  ...
  return (
    ...
    >
      <div className="bg-gray-900 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-700 animate-slideUp">
        ...
        <div className="p-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <h2 className="font-display text-4xl font-bold text-white mb-2">{tv.name}</h2>
