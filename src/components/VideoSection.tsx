...
export default function VideoSection({ videos, videosLoading, videosErrorMessage, tvName }: VideoSectionProps) {
  ...
  return (
    <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-800 mb-8 sm:mb-12">
      <h2 className="font-display text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8 flex items-center space-x-2 sm:space-x-3">
      ...
      {videos.filter(video => video.site === 'YouTube').length > 6 && (
        <div className="text-center mt-6 sm:mt-8">
          <button
            ...
            className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white font-semibold rounded-lg sm:rounded-xl transition-all duration-300 transform hover:scale-105 space-x-2 text-sm sm:text-base"
          >
